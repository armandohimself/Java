...
public class SpeedConverter {
    ...
    public static long toMilesPerHour(double kilometersPerHour) {
        ...
        //conversion algorithm (1 mile per hour is 1.609 kilometers per hour)
        //return rounded value of the calculation of the type long.
    }
 ...
 * Test Cases
Failed: 0, Passed: 18 of 18 tests

- Evaluate.testGroupedNestedTestClasses
- Evaluate$A_MethodDeclarationTest.declarations
- Evaluate$PrintConversionParamsTest.printConversionParams
- Evaluate$PrintConversionParamsTest.printConversionParams
- Evaluate$PrintConversionParamsTest.printConversionParams
- Evaluate$PrintConversionParamsTest.printConversionParams
- Evaluate$PrintConversionParamsTest.printConversionParams
...
- Evaluate$PrintConversionParamsTest.printConversionParams
- Evaluate$PrintConversionParamsTest.printConversionParams
- Evaluate$ToMilesPerHourParamsTest.toMilesPerHourParams
- Evaluate$ToMilesPerHourParamsTest.toMilesPerHourParams
- Evaluate$ToMilesPerHourParamsTest.toMilesPerHourParams
- Evaluate$ToMilesPerHourParamsTest.toMilesPerHourParams
- Evaluate$ToMilesPerHourParamsTest.toMilesPerHourParams
